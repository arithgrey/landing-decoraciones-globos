...
<head>
    ...
    <title>¡Llevamos la cerveza a tu evento CDMX! </title>
            ...
            <div class="row">
                <div class="col-12 col-lg-6 col-md-12 image-wrap-1">
                    <div class="image-wrapper">
                        <img src="imgs/cervezas/evento_cervezas.jpg" alt="">
                    </div>
                </div>
                <div class="col-12 col-lg-6 image-wrap-2">
                    <div class="row">
                        <div class="col-md-6 image-wrap">
                            <div class="image-wrapper">
                                <img src="imgs/cervezas/evento_cervezas_1.jpg" alt="">
                            </div>
                        </div>
                        <div class="col-md-6 image-wrap">
                            <div class="image-wrapper">
                                <img src="imgs/cervezas/evento_cervezas_2.jpg" alt="">
                            </div>
                        </div>
                        <div class="col-md-12 image-wrap">
                            <div class="image-wrapper">
                                <img src="imgs/cervezas/evento_cervezas_4.jpg" alt="">
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <section data-bs-version="5.1" class="slider1 mbr-embla cid-t3PhNQeo5q" id="slider1-a">
        ...
        <div class="position-relative text-center">
            <div class="col-12">
                ...
                <h3 class="mbr-section-subtitle mbr-fonts-style display-3 text-uppercase black_accion d-md-block d-none">
                    <strong>¡Te llevamos la cerveza!</strong>
                </h3>

                <h3 class="mbr-section-subtitle mbr-fonts-style display-7 text-uppercase black_accion d-md-none">
                    <strong>¡Te llevamos la cerveza!</strong>
                </h3>
                <h2 class="mbr-section-title mbr-fonts-style display-3 text-uppercase">
                    <strong>Para cumpleaños / Bautizos / Bodas / Reuniones </strong>
                </h2>
                <p class="mbr-text mbr-fonts-style display-7">
                    <a class="btn btn-primary btn-lg btn-outline-dark" target="_blank" href="https://api.whatsapp.com/send?phone=+525576127281&text=Hola!%20Me%20puedes%20ayudar,%20me%20gustaría%20cotizar%20mi%20evento%20sobre%20las%20cervezas">
                        (55) 7612-7281
                    </a>
                </p>
                <a class="white" target="_blank" href="https://api.whatsapp.com/send?phone=+525576127281&text=Hola!%20Me%20puedes%20ayudar,%20me%20gustaría%20cotizar%20mi%20evento%20sobre%20las%20cervezas">
        ...
        <div class="container-fluid col-md-8 col-mf-offsset-2">
            <div class="fixed-bottom d-flex bg_blue">
                <div class="mb-3 agenda">
                    Cotiza tu evento!
                    <a class="white mr-3" target="_blank" href="https://api.whatsapp.com/send?phone=+525576127281&text=Hola!%20Me%20puedes%20ayudar,%20me%20gustaría%20cotizar%20mi%20evento%20sobre%20las%20cervezas">
                        <span class="fa fa-whatsapp fa-2x">
                        </span>
                    </a>
                </div>
