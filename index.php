...
<body>
    <section data-bs-version="5.1" class="menu bistro_menu1 cid-t3PhvdPAtM" once="menu" id="menu1-0">
        <nav class="navbar navbar-dropdown navbar-expand-lg">
            <div class="menu_box container">
                <div class="navbar-brand d-flex d-lg-none">

                    <span class="navbar-caption-wrap"><a class="navbar-caption display-7" href="">Globolandia</a></span>
                </div>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <div class="navbar-brand d-none d-lg-flex">
                        ...
                        <span class="navbar-caption-wrap"><a class="navbar-caption display-5" href="">Globolandia</a></span>
                    </div>
            ...
            <div class="row">
                <div class="col-12 col-lg-6 mbr-section-head">
                    <h2 class="mbr-section-title mbr-fonts-style display-2 preguntas">
                        <strong>Lo que usualmente nos preguntan!</strong>
                    </h2>
                </div>
                <div class="col-12 col-lg-6">
                    ...
                    <p class="mt-4">
                        En el momento que terminemos de realizar tu decoración podrás pagar con:
                    </p>
                    <p class="mt-4">
                        - Efectivo
                    </p>
                    ...
                    <p>
                        - Pago con tarjeta de débido o crédito
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="container-fluid col-md-8 col-mf-offsset-2">
            <div class="row justify-content-center">
                <div class="col-12 col-lg-4 col-md-6 mt-5 ">
                    <img src="imgs/decoracion_barbie.jpg" alt="">
                </div>
                <div class="col-12 col-lg-4 col-md-6 mt-5 ">
                    <img src="imgs/decoracion_spiderman.jpg" alt="">

                </div>
                <div class="col-12 col-lg-4 col-md-6 mt-5 ">
                    <img src="imgs/decoracion_payasito.jpg" alt="">
                </div>
                <div class="col-12 col-lg-4 col-md-6 mt-5 ">
                    <img src="imgs/decoracion_fut.jpg" alt="">
                </div>
                <div class="col-12 col-lg-4 col-md-6 mt-5 ">
                    <img src="imgs/decoracion_mario.jpg" alt="">
                </div>
                <div class="col-12 col-lg-4 col-md-6 mt-5 ">
                    <img src="imgs/decoracion_pocoyo.jpg" alt="">
                </div>
            </div>
        </div>
    </section>
